...
class ArenaQuestBot {
    ...
    displayStatistics() {
        ...
        console.log(`${colors.green}âœ“ Successful Wallets: ${this.statistics.successfulWallets}`);
        console.log(`${colors.red}âœ— Failed Wallets: ${this.statistics.failedWallets}`);
        console.log(`${colors.cyan}â„¹ Total XP Gained: ${this.statistics.totalXPGained}`);
        console.log(`â„¹ Completed Tasks: ${this.statistics.completedTasks}${colors.reset}`);
